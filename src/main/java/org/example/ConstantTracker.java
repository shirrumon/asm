...
//        if (instruction.getNext().getOpcode() != RETURN) {
//
...
//        //System.out.println("FRAME VAR# "+frame.getLocals());
//        AbstractInsnNode n = m_instructionList.get(i);
//
//        if (n.getOpcode() != Opcodes.ALOAD) continue;
...
//        }
//
//        //ConstantTracker.ConstantValue val = ct.newOperation(instruction.getPrevious());
//        //System.out.println("Test value: " + val.value);
//
//        System.out.println("Nullable check: " + instruction.getPrevious());
//
//        if (instruction.getPrevious().getOpcode() == ALOAD) {
//        VarInsnNode varAload = (VarInsnNode) instruction.getPrevious();
//        int variableInStackPosition = varAload.var;
//        System.out.println("ALOAD var: " + variableInStackPosition);
//        }
//
//        if (instruction.getPrevious().getOpcode() == LDC) {
//        LdcInsnNode ldcVar = (LdcInsnNode) instruction.getPrevious();
//        System.out.println("LDC var: " + ldcVar.cst);
//
//                            /*
//                            Patrz: tu jest tak ze jak static jest NULL to powraca
//                            GETSTATIC org/example/TestCase.MESSAGE : Ljava/lang/String;
//                            czyli null
//                            *  */
//        }
//
//        if (instruction.getPrevious().getOpcode() == GETSTATIC) { //static null check
//        FieldInsnNode staticVar = (FieldInsnNode) instruction.getPrevious();
//        System.out.println("Nullable check: " + staticVar.name);
//        }
//        }
//
////                    if (m_instructionList.get(m_i - 2) instanceof LineNumberNode) {
////                        LineNumberNode lnn = (LineNumberNode) m_instructionList.get(m_i - 2);
////                        System.out.println("Nullable if on line: " + lnn.line);
////                    }
////
////                    if (m_instructionList.get(m_i - 3) instanceof LineNumberNode) {
////                        LineNumberNode lnn = (LineNumberNode) m_instructionList.get(m_i - 3);
////                        System.out.println("Nullable if on line: " + lnn.line);
////                    }
//        }

//    private Object getFieldVar(int fieldVar) throws IOException {
